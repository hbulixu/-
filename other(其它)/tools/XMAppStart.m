...
-(void) saveDataToDb:(NSString *)dataBaseFile
{
    ...
    //创建行程日记表
    NSString *createTravelassistantSql = @"CREATE TABLE IF NOT EXISTS travelassistant(id INTEGER PRIMARY KEY AUTOINCREMENT,city TEXT,time TEXT,money TEXT,noteCount INTEGER,touristCount INTEGER,hotel TEXT,diary INTEGER,cityType TEXT)";
